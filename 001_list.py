...
print('6. extend, update & clear')
num.extend(reply)
print('   The result of "num.extend(reply)" is', num)
print('   The result of ["ok" in num] is', 'ok' in num) 
#print('   The result of "set(fruits).update(set(reply))" is', set(fruits).update(set(reply)))
#del price[1:1]  #?
#print(price)
num.clear()
